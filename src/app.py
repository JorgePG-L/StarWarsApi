...
from models.index import db, Planet, User, Character, Favorites 
from domain.user.route import user_route
from domain.planets.route import planet_route
from domain.character.route import character_route
# from domain.favorites.route import favorites_route
